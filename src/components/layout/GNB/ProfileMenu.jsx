...
export const ProfileMenu = ({ user, onLogout, onClose }) => {
  return (
    <>
      ...
      {/* 메뉴 패널 */}
      <div className="fixed top-0 left-0 z-50 flex h-screen w-[16.25rem] flex-col bg-gray-500 sm:top-[4.375rem] sm:left-auto sm:right-[2.5rem] sm:h-auto lg:top-[5rem] lg:right-[13.75rem]">
        {/* 헤더 */}
        <div className="border-b border-gray-400/50 px-5 pt-[2.6875rem] pb-5 sm:pt-5">
          ...
          <div className="flex items-center justify-between">
            <span className="text-noto-12-light text-gray-300">보유 포인트</span>
